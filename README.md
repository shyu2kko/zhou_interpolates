...
This repository contains scripts and functions to reproduce results in "Benchmarking spatial interpolation methods for brain maps," now available as a preprint.
